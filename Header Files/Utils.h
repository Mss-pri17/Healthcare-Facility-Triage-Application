...
namespace seneca {
    ...
    /// <summary>
    /// Removes a dynamic element from a dynamically allocated array of pointers.
    /// </summary>
    /// <typeparam name="type">The type of the elements in the array.</typeparam>
    /// <param name="array">The dynamically allocated array of pointers to remove the element from.</param>
    /// <param name="index">The index of the element to be removed from the array.</param>
    /// <param name="size">A reference to an integer representing the current size of the array. This value will be decremented by 1 after the removal.</param>
